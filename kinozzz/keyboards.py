...
btnurl=InlineKeyboardButton(text="ПОДПИСАТЬСЯ", url="https://t.me/+V36kPXfnJpc5Mzdi")

btndonesub=InlineKeyboardButton(text="Я подписался ✅", callback_data="subchanneldone")
forsubkeyboard=InlineKeyboardMarkup()
forsubkeyboard.insert(btnurl)
forsubkeyboard.insert(btndonesub)
