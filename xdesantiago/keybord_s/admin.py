...
admin_menu_main.row(InlineKeyboardButton(text='Плееры▶️', callback_data='player_settings_admin'))
admin_menu_main.row(InlineKeyboardButton(text='Тексты📝', callback_data='text_settings_admin'))
