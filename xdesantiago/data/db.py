...
try:
    data=['wellcome', '*Привет,* [{full_name}](tg://user?id={user_id}) *ты в {username_bot} это самый лучший бот по фильмам, введи код фильма в чат или можешь найти любой фильм по названию👇*']
